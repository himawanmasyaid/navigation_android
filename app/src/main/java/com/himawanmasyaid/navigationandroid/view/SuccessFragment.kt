...
import com.himawanmasyaid.navigationandroid.databinding.FragmentSuccessBinding
...
class SuccessFragment: BaseFragment<FragmentSuccessBinding>(FragmentSuccessBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            findNavController().navigate(SuccessFragmentDirections.actionToHomeFragment())
